...
import { cartsTable, type Cart } from '../db/schema/cart';
import { cartItemsTable, type CartItem } from '../db/schema/cartItems';
...
export class CartService {
  ...
  static async updateQuantity(
    ...
    const { subtotalPence, discountPence } =
      await CartService.getCartTotal(userId);
