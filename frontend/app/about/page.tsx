...
const TIMELINE = [
  {
    year: "2020",
    title: "Founded in a Kitchen",
    text: "Verdant started when our founders couldn't find truly fresh produce in the city.",
  },
  {
    year: "2021",
    title: "First 10 Farms",
    text: "We partnered with 10 local farms in Kent and Sussex to pilot same-day delivery.",
  },
  {
    year: "2022",
    title: "100,000 Customers",
    text: "We reached 100,000 happy customers and expanded to Yorkshire and the South West.",
  },
  {
    year: "2024",
    title: "120+ Partner Farms",
    text: "Today we work with over 120 family farms across England and Scotland.",
  },
];
      ...
      <main className="pt-24 bg-cream">
        <div className="relative h-96 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-20">
            <p className="text-xs tracking-[0.2em] uppercase text-green-pale mb-4">
              Our Story
            </p>
            ...
            <p className="text-white/80 mt-4 max-w-lg text-base leading-relaxed">
              We started Verdant because we believed food should taste like it
              was just picked. Because it should be.
            </p>
          </div>
        </div>
        ...
        <div className="px-20 py-20 grid grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-verdant-muted leading-[1.85] text-base">
              Every week, millions of people eat produce that was picked weeks
              ago, shipped thousands of miles, and stored in refrigerated
              warehouses. We think that&apos;s broken. Verdant exists to fix it
              — one farm partnership at a time.
            </p>
            <p className="text-verdant-muted leading-[1.85] text-base mt-4">
              We work exclusively with farms within 60 miles of the communities
              we serve. We pay farmers fairly. We deliver within 24 hours of
              harvest. And we never compromise on quality.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div
                key={s.label}
                className="bg-white rounded-2xl p-6 border border-green/10"
              >
                <div className="text-3xl mb-3">{s.icon}</div>
                <div className="font-playfair text-3xl font-bold text-green">
                  {s.num}
                </div>
          ...
          <div className="relative">
            ...
            <div className="flex flex-col gap-12">
              {TIMELINE.map((t, i) => (
                <div
                  key={t.year}
                  className={`flex items-start gap-10 ${i % 2 === 0 ? "flex-row" : "flex-row-reverse"}`}
                >
                  <div className="flex-1 flex justify-end">
                    <div
                      className={`bg-white rounded-2xl p-6 max-w-sm border border-green/10 shadow-sm ${i % 2 !== 0 ? "opacity-0 pointer-events-none" : ""}`}
                    >
                      {i % 2 === 0 && (
                        <>
                          <div className="font-playfair text-green font-bold text-xl mb-1">
                            {t.title}
                          </div>
          ...
          <div className="grid grid-cols-4 gap-8">
            {TEAM.map((m) => (
              <div key={m.name} className="text-center group">
                ...
                <div className="font-playfair font-bold text-verdant-dark text-lg">
                  {m.name}
                </div>
        ...
        <div className="px-20 pb-20">
          <div className="bg-verdant-dark rounded-3xl p-16 text-center relative overflow-hidden">
            <span className="absolute top-4 left-12 text-8xl opacity-5">
              🌾
            </span>
            ...
            <p className="text-white/60 max-w-md mx-auto mb-8">
              Order before 10am and your produce is harvested, packed, and on
              its way the same day.
            </p>
            <Link
              href="/shop"
