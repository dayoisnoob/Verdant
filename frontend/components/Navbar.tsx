        ...
        <div className="flex items-center justify-between px-6 md:px-10 lg:px-16 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              {!isHydrated ? (
                <>
                  <div className="hidden md:block h-9 w-28 rounded-full bg-[#e8e8e8] animate-pulse" />
                  <div className="h-9 w-24 rounded-full bg-green/20 animate-pulse" />
                  <div className="md:hidden h-9 w-9 rounded-full bg-green-pale animate-pulse" />
                </>
              ) : (
                <>
                  ...
                  >
                    ...
                    {isLoading ? (
                      <span className="w-5 h-5 rounded-full bg-white/20 animate-pulse" />
                    ) : totalQuantity > 0 ? (
